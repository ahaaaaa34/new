...
const EIGO_SENTENCES = [
  ...
  { en: "They could soon become extinct.", ja: "それらはまもなく絶滅するかもしれません。", grammar: "could + 動詞の原形 で「〜するかもしれない」。become extinct は「絶滅する」。" },
  { en: "Extinction happens when the last animal of the species has died out.", ja: "絶滅は、その種の最後の動物が死に絶えたときに起こります。", grammar: "when ～ は「〜するとき」。has died out は現在完了で「死に絶えてしまった」。" },
  { en: "Then there will be no more.", ja: "そのとき、その種はもう存在しなくなります。", grammar: "There will be ～ は「〜があるだろう」。no more は「もうない」。" },
  { en: "Many species are nearly extinct.", ja: "多くの種はほとんど絶滅しかけています。", grammar: "nearly は「ほとんど」。be extinct で「絶滅している」。" },
  { en: "They could disappear from the Earth very soon.", ja: "それらはまもなく地球上から消えてしまうかもしれません。", grammar: "could + 動詞の原形。disappear from ～ は「〜から消える」。" },
  { en: "This will happen if we don't do anything to save them.", ja: "もし私たちが救うために何もしなければ、そうなります。", grammar: "if + 主語 + 現在形 で未来の条件を表す。to save them は「それらを救うために」。" },
  { en: "There are many reasons why species become endangered.", ja: "種が絶滅の危機にさらされる理由はたくさんあります。", grammar: "There are ～ は「〜がある」。reasons why ～ は「〜する理由」。" },
  { en: "But most harm to species is due to human activities.", ja: "しかし、種への害のほとんどは人間の活動によるものです。", grammar: "be due to ～ は「〜が原因である」。" },
  { en: "These activities include habitat destruction, hunting and overfishing.", ja: "その活動には、生息地の破壊、狩猟、乱獲が含まれます。", grammar: "include ～ は「〜を含む」。" },
  { en: "Habitat destruction is the main reason.", ja: "生息地の破壊が主な理由です。", grammar: "main は「主な」。reason は「理由」。" },
  { en: "It is why animals become endangered.", ja: "それが動物が絶滅危惧種になる理由です。", grammar: "why + 文 で「〜する理由」。become endangered は「絶滅危惧になる」。" },
  { en: "This happens in two ways.", ja: "これは二つの形で起こります。", grammar: "in two ways は「二つの方法で」。" },
  { en: "First, humans move into a new area.", ja: "まず、人間が新しい地域に移り住みます。", grammar: "move into ～ は「〜に移り住む」。" },
  { en: "They cut down trees to build houses and farms.", ja: "家や農場を作るために木を切り倒します。", grammar: "cut down は「切り倒す」。to build ～ は「〜を建てるために」。" },
  { en: "This destroys the animals' habitat.", ja: "これは動物の生息地を破壊します。", grammar: "destroy + 目的語 で「〜を破壊する」。animals' は「動物たちの」。" },
  { en: "A habitat is the natural environment.", ja: "生息地とは自然環境のことです。", grammar: "A is B の形。natural environment は「自然環境」。" },
  { en: "Plants or animals usually live there.", ja: "植物や動物はふつうそこで暮らしています。", grammar: "usually は「ふつう」。live there は「そこで暮らす」。" },
  { en: "This leaves animals without food.", ja: "これによって動物は食べ物を失います。", grammar: "leave A without B は「AをBなしの状態にする」。" },
  ...
  { en: "Dirty water from factories contains chemicals.", ja: "工場からの汚れた水には化学物質が含まれています。", grammar: "from factories は「工場からの」。contain は「〜を含む」。" },
  { en: "It ends up in rivers.", ja: "それは川に流れ込みます。", grammar: "end up in ～ は「最終的に〜に行き着く」。" },
  { en: "Poisons used on farmland may even kill animals.", ja: "農地で使われる毒物は動物を殺すことさえあります。", grammar: "used on farmland は前の poisons を説明。may は「〜かもしれない」。" },
  { en: "These animals live in the area.", ja: "その動物たちはその地域に住んでいます。", grammar: "live in ～ は「〜に住む」。" },
  { en: "Endangered species are also the result of hunting and fishing.", ja: "絶滅危惧種は狩猟や漁業の結果でもあります。", grammar: "the result of ～ は「〜の結果」。" },
  { en: "Animals such as the Arabian oryx are nearly extinct.", ja: "アラビアオリックスのような動物はほとんど絶滅しかけています。", grammar: "such as ～ は「〜のような」。nearly extinct は「ほとんど絶滅した」。" },
  { en: "This is because of the high price of their meat.", ja: "これはその肉が高値で売れるからです。", grammar: "because of + 名詞 は「〜のために」。the price of ～ は「〜の値段」。" },
  { en: "Other animals are killed for their fur, bones or skin.", ja: "ほかの動物は毛皮、骨、皮のために殺されます。", grammar: "are killed は受け身。for ～ は「〜のために」。" },
  { en: "Some are killed just for sport.", ja: "スポーツ目的だけで殺される動物もいます。", grammar: "Some は「一部の動物」。just for ～ は「ただ〜のためだけに」。" },
  { en: "For example, some seal species are now almost extinct.", ja: "例えば、いくつかのアザラシの種は今ではほとんど絶滅しています。", grammar: "For example は「例えば」。almost extinct は「ほとんど絶滅している」。" },
  { en: "They are killed for their fur.", ja: "それらは毛皮のために殺されます。", grammar: "are killed は受け身。their fur は「それらの毛皮」。" },
  { en: "The fur is used to make coats.", ja: "その毛皮はコートを作るために使われます。", grammar: "is used は受け身「使われる」。to make coats は「コートを作るために」。" },
  { en: "Tigers are shot to make medicine and tea.", ja: "トラは薬やお茶を作るために撃たれます。", grammar: "are shot は受け身。to make ～ は目的「〜を作るために」。" },
  { en: "These are made from their bones.", ja: "それらはトラの骨から作られます。", grammar: "be made from ～ は「〜から作られる」。" },
  { en: "Crocodiles are caught to make bags and shoes.", ja: "ワニはバッグや靴を作るために捕まえられます。", grammar: "are caught は受け身。to make ～ は「〜を作るために」。" },
  { en: "Large sea creatures have all become endangered species.", ja: "大型の海の生き物はすべて絶滅危惧種になっています。", grammar: "have become は現在完了。「〜になってしまった」。" },
  { en: "These include whales, tuna and sharks.", ja: "それにはクジラ、マグロ、サメが含まれます。", grammar: "include + 名詞 で「〜を含む」。" },
  { en: "This is because of overfishing.", ja: "これは乱獲のためです。", grammar: "because of + 名詞。overfishing は「乱獲」。" },
  { en: "Too many are caught.", ja: "あまりにも多く捕らえられています。", grammar: "are caught は受け身。too many は「多すぎる数」。" },
  { en: "They are caught to make special dishes.", ja: "それらは特別な料理を作るために捕らえられます。", grammar: "to make special dishes は目的「特別な料理を作るために」。" },
  { en: "People like to eat these dishes.", ja: "人々はこれらの料理を食べるのが好きです。", grammar: "like to 動詞の原形 は「〜するのが好き」。" },
  { en: "Examples are shark's fin soup and sushi.", ja: "例として、フカヒレスープや寿司があります。", grammar: "Examples are ～ は「例は〜です」。shark's fin は「サメのひれ」。" },
  { en: "What steps can individuals and governments take?", ja: "個人や政府はどのような対策を取ることができるでしょうか。", grammar: "What + 名詞 + can 主語 + 動詞？ の疑問文。take steps は「対策を取る」。" },
  { en: "They need to protect more animal and plant species.", ja: "彼らはより多くの動物や植物の種を守る必要があります。", grammar: "need to 動詞の原形 は「〜する必要がある」。" },
  { en: "They should stop them from becoming endangered.", ja: "それらが絶滅危惧種になるのを防ぐべきです。", grammar: "stop A from ～ing は「Aが〜するのを防ぐ」。" },
  { en: "We should try not to pollute natural areas.", ja: "私たちは自然地域を汚染しないように努めるべきです。", grammar: "should は「〜すべき」。try not to ～ は「〜しないように努める」。" },
  { en: "Farmers or companies may destroy animal habitats.", ja: "農家や企業が動物の生息地を破壊することがあります。", grammar: "may + 動詞の原形 は「〜するかもしれない」。" },
  { en: "They should face a financial penalty.", ja: "彼らは金銭的な罰を受けるべきです。", grammar: "face a penalty は「罰を受ける」。financial は「金銭的な」。" },
  { en: "The public can help out.", ja: "一般の人々も助けることができます。", grammar: "can + 動詞の原形。help out は「助ける、手伝う」。" },
  { en: "They can refuse to buy products made from animals' body parts.", ja: "動物の体の一部から作られた製品を買わないことで助けられます。", grammar: "refuse to ～ は「〜することを拒む」。made from ～ は前の products を説明。" },
  { en: "Examples are seal fur coats or crocodile bags.", ja: "例として、アザラシの毛皮のコートやワニ革のバッグがあります。", grammar: "Examples are ～ は「例は〜です」。" },
  { en: "Governments can help, too.", ja: "政府も助けることができます。", grammar: "too は文末で「〜も」。" },
  { en: "They can make it against the law to hunt endangered species.", ja: "絶滅危惧種を狩ることを法律で禁止できます。", grammar: "make it against the law to ～ は「〜することを違法にする」。" },
  { en: "They can also make it illegal to fish or trade in them.", ja: "それらを捕ったり取引したりすることも違法にできます。", grammar: "make it illegal to ～ は「〜することを違法にする」。them は endangered species を指す。" },
  { en: "They can also provide funding.", ja: "政府は資金を提供することもできます。", grammar: "provide + 名詞 は「〜を提供する」。also は「また」。" },
  { en: "The funding can go to animal sanctuaries and zoos.", ja: "その資金は動物保護区や動物園に使われます。", grammar: "go to ～ はここでは「〜に回される」。" },
  { en: "These places protect animals from extinction.", ja: "これらの場所は動物を絶滅から守ります。", grammar: "protect A from B は「AをBから守る」。" },
  { en: "They do this by breeding more endangered animals.", ja: "絶滅危惧動物をより多く繁殖させることで守ります。", grammar: "by ～ing は「〜することによって」。breed は「繁殖させる」。" },
  { en: "These animals can later be released into the wild.", ja: "これらの動物は後に野生に戻すことができます。", grammar: "can be 過去分詞 は「〜されることができる」。be released into the wild は「野生に放される」。" },
  { en: "If we all cooperate, we will protect our planet.", ja: "もし私たち全員が協力すれば、地球を守ることができます。", grammar: "If + 現在形, will + 動詞の原形 で「もし〜なら、〜するだろう」。" },
  { en: "We can do this by taking these steps.", ja: "これらの対策を取ることで、それができます。", grammar: "by ～ing は「〜することによって」。take steps は「対策を取る」。" },
  { en: "Then our children and their children can enjoy it, too.", ja: "そうすれば、私たちの子どもやその子どもたちも地球を楽しめます。", grammar: "Then は「そうすれば」。it は our planet を指す。too は「〜も」。" }
];
